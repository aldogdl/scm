        ...
        children: [
          ...
          IconButton(
            ...
            constraints: const BoxConstraints(
              maxHeight: 23, maxWidth: 20
            ),
            padding: const EdgeInsets.all(0),
            onPressed: (){
              context.read<ProcessProvider>().verColaMini = !context.read<ProcessProvider>().verColaMini; 
            },
            icon: Selector<ProcessProvider, bool>(
              selector: (_, provi) => provi.verColaMini,
              builder: (_, s, __) {
                return Icon(
                  (s) ? Icons.list : Icons.home_max_outlined,
                  size: 18,
                );
              },
            ),
